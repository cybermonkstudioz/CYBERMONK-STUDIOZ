...
const Portfolio = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      category: 'app',
      description: 'Productivity app for team collaboration and project tracking',
      image: 'https://source.unsplash.com/random/800x600/?productivity',
      url: '/portfolio/task-management-app',
    ...
    },
    {
      ...
      image: 'https://source.unsplash.com/random/800x600/?design,system',
      url: '/portfolio/visual-design-system',
    ...
    },
    {
      ...
      category: 'design',
      description: 'Complete brand guidelines and visual identity manual',
      image: 'https://source.unsplash.com/random/800x600/?guidelines',
      url: '/portfolio/brand-guidelines',
